...
\begin{table}[h]
	\begin{tabular}{lll}
		...
		New                        & Ctrl+Shift+N                                                                        & \begin{tabular}[c]{@{}l@{}}Create new project\\ Close/discard open project\end{tabular}             \\
		Open                       & Ctrl+O                                                                              & Open existing project                                                                               \\
		Save                       & Ctrl+S                                                                              & Save current project                                                                                \\
		Save As                    & Ctrl+Alt+S                                                                          & Save current project as new file                                                                    \\
		Print                      & Ctrl+P                                                                              & Print diagram                                                                                       \\
		Export                     & Ctrl+E                                                                              & Export project to PNG                                                                               \\
		&                                                                                     &                                                                                                     \\
		\textbf{Ribbon: Edit}      &                                                                                     &                                                                                                     \\
		Undo                       & Ctrl+Z                                                                              & Undo previous actions                                                                               \\
		Redo                       & Ctrl+Shift+Z                                                                        & Redo actions                                                                                        \\
		Paste                      & Ctrl+V                                                                              & Paste class from clipboard                                                                          \\
		Cut                        & Ctrl+X                                                                              & Cut class                                                                                           \\
		Copy                       & Ctrl+C                                                                              & Copy selected class                                                                                 \\
		New Class                  & Ctrl+N                                                                              & Add class                                                                                           \\
		Delete Class               & Delete                                                                              & Delete selected class                                                                               \\
		Relations                  &                                                                                     & \begin{tabular}[c]{@{}l@{}}Add relation between classes\\ (enter add relation mode)\end{tabular}    \\
		Delete relation            &                                                                                     & \begin{tabular}[c]{@{}l@{}}Delete relation\\ (show circle, enter delete relation mode)\end{tabular} \\
		&                                                                                     &                                                                                                     \\
		\textbf{Canvas functions}  &                                                                                     &                                                                                                     \\
		Select class               & Click on class                                                                      &                                                                                                     \\
		Drag class                 & Drag class with mouse                                                               &                                                                                                     \\
		Add relation               & \begin{tabular}[c]{@{}l@{}}Click on class "from"\\ Click on class "to"\end{tabular} & (during add relation mode)                                                                          \\
		Delete relation            & Click on relation (circle)                                                          & (during delete relation mode)                                                                       \\
		Change class name          & Click on text field                                                                 &                                                                                                     \\
		Add field / method         & Click +                                                                             &                                                                                                     \\
		Remove field / method      & Click X                                                                             &                                                                                                     \\
		Edit field/method text     & Click on text field                                                                 &                                                                                                     \\
		Edit relation text         & Click on text field                                                                 &                                                                                                    
	\end{tabular}
\end{table}
