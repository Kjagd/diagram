...
The class also contains some of the infomation needed to render it properly, such as
...
the object, which results in an entierly new object to ensure that the new 
