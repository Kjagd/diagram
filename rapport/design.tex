...
\begin{table}[h] \begin{tabular}{lll} \textbf{Ribbon: File menu} &
&
\\ New                        & Ctrl+Shift+N
& \begin{tabular}[c]{@{}l@{}}Create new project\\ Close/discard open
project\end{tabular}             \\ Open                       & Ctrl+O
...
\\ Relations                  &
& \begin{tabular}[c]{@{}l@{}}Add relation between classes\\ (enter add relation
mode)\end{tabular}    \\ Delete relation            &
& \begin{tabular}[c]{@{}l@{}}Delete relation\\ (show circle, enter delete
relation mode)\end{tabular} \\ &
&
...
&
\\ Add relation               & \begin{tabular}[c]{@{}l@{}}Click on class
"from"\\ Click on class "to"\end{tabular} & (during add relation mode)
\\ Delete relation            & Click on relation (circle)
& (during delete relation mode)
